  ...
  constructor(props) {
    ...
    _defineProperty(this, "_open", async config => {
      if (this.state.visible) {
        ...
        await this._startAnimation(_config.ACTION.CLOSE, false);
        await new Promise(resolve => this.setState(prevState => ({ ...prevState,
          config
        }), resolve));
        await this._startAnimation(_config.ACTION.OPEN);
        return;
      }
    ...
    _defineProperty(this, "_close", async () => {
      ...
      await this._startAnimation(_config.ACTION.CLOSE);
    ...
    _defineProperty(this, "_showModalHandler", async () => {
      ...
      if (autoClose) {
        const duration = typeof autoClose === 'number' ? autoClose : _config.ENV.AUTO_CLOSE;
    ...
    _defineProperty(this, "_startAnimation", function (action) {
      ...
      const open = action === _config.ACTION.OPEN;
      let animations = [opacity ? _reactNative.Animated.timing(_this._opacity, {
        toValue: action === _config.ACTION.OPEN ? 1 : 0,
        duration: 300,
        useNativeDriver: false
      }) : null, _reactNative.Animated[open ? 'spring' : 'timing'](_this._positionDialog, {
        toValue: open ? _config.ENV.WINDOWS.HEIGHT / 2 - _this._popupHeight / 2 : _config.ENV.WINDOWS.HEIGHT + 30,
        ...(open ? {
          bounciness: 12
        } : {
          duration: 250
      ...
      return new Promise(resolve => {
        _reactNative.Animated.sequence(animations).start(() => resolve());
      });
    });
    ...
    _defineProperty(this, "_buttonRender", () => {
      ...
      if (button) {
        return /*#__PURE__*/React.createElement(_reactNative.TouchableOpacity, {
          style: _reactNative.StyleSheet.flatten([styles.button, styles[type]]),
    ...
    _defineProperty(this, "_CardRender", () => {
      ...
      return /*#__PURE__*/React.createElement(_reactNative.Animated.View, {
        ...
        style: _reactNative.StyleSheet.flatten([styles.cardContainer, {
          transform: [{
      ...
      }, textBody)), /*#__PURE__*/React.createElement(_reactNative.View, {
    ...
    _defineProperty(this, "render", () => {
      ...
      return /*#__PURE__*/React.createElement(_reactNative.Modal, {
        ...
        style: _reactNative.StyleSheet.flatten([styles.backgroundContainer, {
          opacity: this._opacity
        }])
      }), /*#__PURE__*/React.createElement(_OverlayCloseRender, null), /*#__PURE__*/React.createElement(_CardRender, null));
    });

    this._opacity = new _reactNative.Animated.Value(0);
    this._positionDialog = new _reactNative.Animated.Value(_config.ENV.WINDOWS.HEIGHT + 30);
    this._popupHeight = 0;
    this.state = {
...
const __styles = isDark => _reactNative.StyleSheet.create({
  ...
  [_config.ALERT_TYPE.SUCCESS]: {
    backgroundColor: _service.Color.get('success', isDark)
  },
  [_config.ALERT_TYPE.DANGER]: {
    backgroundColor: _service.Color.get('danger', isDark)
  },
  [_config.ALERT_TYPE.WARNING]: {
    backgroundColor: _service.Color.get('warning', isDark)
  },
  [_config.ALERT_TYPE.INFO]: {
    backgroundColor: _service.Color.get('info', isDark)
  },
  backendImage: {
    position: 'absolute',
    alignSelf: 'center',
